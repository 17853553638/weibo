...
$('input[name="btn_submit"]').click(function (){
	...
	// var hotAdd = document.getElementsByClassName('hot-add')[0]
	// var inputValue = $('input[name="btn_submit"]').val()
	//var newEle = $("div")
	//newEle.addClass("col-sm-12 item_hot")
	//newEle.html('<span class="pull-left"><a href="https://lol.qq.com/">#'+inputValue+'#</a></span><span class="pull-right item_num">34.6亿</span>')
	//newEle.prepend(hotAdd)
  });
/*  $('#btn_submit').click(function(){
	 var hotAdd = document.getElementsByClassName('hot-add')[0]
		var inputValue = $('#btn_submit').val()
		console.log(inputValue)
		inputValue.prepend(hotAdd)
 })
}); */
</script>
...
<body>
	<nav class="navbar  navbar-fixed-top" role="navigation"
		...
		<div class="container-fluid" style="background: #fff;">
			...
			<form action="queryservlet" class="navbar-form navbar-left"
				role="search" id="formid">
				<div class="form-group">
					<input name="topic" type="text" class="form-control"
						placeholder="#热门话题#"> <i
						class="glyphicon glyphicon-search btn_search"></i>
					<button type="submit" class="btn btn-default"  id="btn_submit"
						style="width: 50px; height: 20px; color: black">提交</button>
				</div>
		...
		<div class="row">
			...
			<div class="col-sm-6 col-xs-12 my_edit">
				<div class="row" id="edit_form">
					...
					<form action="fb.do" method="post" enctype="multipart/form-data"
						role="form" style="margin-top: 50px;">
						<div class="form-group">
							<div class="col-sm-12">
								...
								<div class="myEmoji">
									<ul id="myTab" class="nav nav-tabs">
										<li class="active"><a href="#set" data-toggle="tab">
												预设 </a></li>
										<li><a href="#hot" data-toggle="tab">热门</a>
										</闪电>
									</ul>
			...
			<div class="col-sm-3 col-xs-12 part_right">
				...
				<div class="row part_hot">
					...
					<div class="hot-add">
						...
						<div class="col-sm-12 item_hot">
							<span class="pull-left"><a href="http://xyq.163.com/">#梦幻西游#</a></span>
