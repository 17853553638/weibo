	...
	<div class="container-fluid"
		...
		<form class="navbar-form navbar-left" role="search" action=""
			...
			<div class="form-group">
				...
				<i class="glyphicon glyphicon-search btn_search"></i> <input
					type="submit" class="btn btn-default" value="提交" />
			</div>
		...
		<div class="collapse navbar-collapse" id="my-navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown"><a href="init.do" class="dropdown-toggle">主页</a>
					<!--	
	...
	<!--  	<div class="row" id="edit_form">
							...
							<div class="col-sm-10 col-xs-10">
								...
								<div class="col-sm-12 col-xs-12 message">
									<ul style="list-style: none">
										<li style="margin-left: 20px; float: left;">赞(${wb.dzsum })</li>
										<li style="margin-left: 120px; float: left;">评论(${wb.pinglun })</li>
										<li style="margin-left: 300px">转发</li>
									</ul>
									<div style="margin-left: 200px; float: left; color: #0ff0ff">
										<r:forEach items="${wb.coms }" var="c">
												${c.time }	 :  ${c.username }:${c.content } <br>
										</r:forEach>
									</div>
								</div>
							</div>
			...
			<div class="col-sm-3 col-xs-12 part_right">
				<div class="row text-center inform">
					...
					<form action="ud_head_pic" method="post" enctype="multipart/form-data">
					<div class="col-sm-12" style="margin-top: 20px;">
							    	<!-- <span class="emoji" >表情</span> -->

							    	<span class="pic" >更换头像</span>
							    	...
							    	<!-- <span> <input type="file" id="selectImg" value=""></input> </span> -->
									<input type="submit" id="send"
									class="btn btn-default pull-right " value="提交">
							    </div>
					  </form>
				...
				<div class="row part_hot">
					...
					<div class="col-sm-12 item_hot">
						<span class="pull-left"><a href="https://lol.qq.com/">#英雄联盟s7#</a></span> <span
							class="pull-right item_num">34.6亿</span>
					</div>

					<div class="col-sm-12 item_hot">
						<span class="pull-left"><a href="http://wenjing.ytu.edu.cn/">#烟台大学文经学院#</a></span> <span
							class="pull-right item_num">2.6亿</span>
					</div>

					<div class="col-sm-12 item_hot">
						<span class="pull-left"><a href="http://pop.weibo.com/">#亚洲新歌榜#</a></span> <span
							class="pull-right item_num">10.4亿</span>
					</div>

					<div class="col-sm-12 item_hot">
						<span class="pull-left"><a href="https://wenda.so.com/q/1375843984067396?src=150">#健身的方法#</a></span> <span
							class="pull-right item_num">1.5亿</span>
					</div>

					<div class="col-sm-12 item_hot">
						<span class="pull-left"><a href="http://xyq.163.com/">#梦幻西游#</a></span> <span
